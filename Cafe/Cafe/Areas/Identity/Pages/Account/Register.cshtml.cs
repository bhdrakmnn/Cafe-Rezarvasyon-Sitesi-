        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser
                {
                    ...
                    Email = Input.Email,//yani email adresini hem email hemde username için kullandım.
                    Name = Input.Name,
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirm your email",
                        $"Lütfen hesabınızı şu tarihe kadar onaylayın: <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>Buraya tıklayın</a>.");
